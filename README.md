...
| [knowledge-rag](https://github.com/lyonzin/knowledge-rag) | [knowledge-rag] - Drop docs, search instantly from Claude Code — 13 MCP tools, 20 format parsers, hybrid search + reranking. Zero servers, zero API keys, 100% local. |
